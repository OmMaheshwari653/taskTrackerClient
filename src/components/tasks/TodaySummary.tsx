...
export const TodaySummary: React.FC<TodaySummaryProps> = ({
  ...
  if (loading && !summary) {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6 w-full">
        {[1, 2, 3].map((i) => (
          <div key={i} className="glass-panel rounded-2xl p-5 animate-pulse space-y-2 w-full">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6 w-full">
      ...
      <div className="glass-panel-interactive rounded-2xl p-5 flex flex-col justify-between space-y-3 w-full">
      ...
      <div className="glass-panel-interactive rounded-2xl p-5 flex flex-col justify-between space-y-3 w-full">
        <div className="flex items-center justify-between text-slate-600">
          ...
          <div className="w-8 h-8 rounded-xl bg-sky-600 text-white flex items-center justify-center shadow-sm shrink-0">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
